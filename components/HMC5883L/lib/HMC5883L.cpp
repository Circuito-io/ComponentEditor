...
bool HMC5883L::begin(float deg, float min)
{   
...
void HMC5883L::setDefultSetting()
{
...
float HMC5883L::getHeadingRad()
{
  ...
  // For Bytom / Poland declination angle is 4'26E (positive)
  // Formula: (deg + (min / 60.0)) / (180 / M_PI);
  float declinationAngle = (m_deg + (m_min / 60.0)) / (180 / M_PI);
...
float HMC5883L::getHeadingDeg()
{
  return getHeadingRad() * 180/M_PI; 
}

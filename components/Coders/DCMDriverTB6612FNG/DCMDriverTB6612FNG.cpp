...
*/
DCMDriverTB6612FNG::DCMDriverTB6612FNG(const int enA, const int pinA1, const int pinA2, const int enB, const int pinB1, const int pinB2) : m_enA(enA), m_enB(enB), m_pinA1(pinA1), m_pinA2(pinA2), m_pinB1(pinB1), m_pinB2(pinB2)
{
...
*/
void DCMDriverTB6612FNG::setMotorA(int speed, bool dir)
{
...
*/
void DCMDriverTB6612FNG::setMotorB(int speed, bool dir)
{
	setMotor(m_enB, m_pinB1, m_pinB2, speed, dir);
}
/**Stop DC motor A.
*/
void DCMDriverTB6612FNG::stopMotorA()
{
	off(m_enA, m_pinA1, m_pinA2);
}
/**Stop DC motor B.
*/
void DCMDriverTB6612FNG::stopMotorB()
{
	off(m_enB, m_pinB1, m_pinB2);
}
/**Stop both DC motors.
*/
void DCMDriverTB6612FNG::stopMotors()
{
	stopMotorA();
	stopMotorB();
}
...
*/
void DCMDriverTB6612FNG::setMotor(int pinPWM, int pinDir1, int pinDir2, int speed, bool dir)
{
...
/**Turn off DC motor
*/
void DCMDriverTB6612FNG::off(int pinPWM, int pinDir1, int pinDir2)
{

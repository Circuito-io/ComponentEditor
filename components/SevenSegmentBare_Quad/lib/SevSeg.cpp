...
// SevSeg Constructor
/******************************************************************************/
SevSeg::SevSeg( byte segmentPinsIn[], byte digitPinsIn[], byte numDigitsIn, byte hardwareConfig,
           bool resOnSegmentsIn, bool updateWithDelaysIn, bool leadingZerosIn)
{
  // Initial value
  ...
  resOnSegments = 0;
  updateWithDelays = 0;
  begin( digitPinsIn, segmentPinsIn, numDigitsIn, hardwareConfig,resOnSegmentsIn, updateWithDelaysIn, leadingZerosIn);
}
...
void SevSeg::begin( byte segmentPinsIn[], byte digitPinsIn[], byte numDigitsIn, byte hardwareConfig,
           bool resOnSegmentsIn, bool updateWithDelaysIn, bool leadingZerosIn) {
